...
SDK_ROOT := /usr/local/nRF5_SDK_15.3.0
PROJ_DIR := .

$(OUTPUT_DIRECTORY)/nrf52840_xxaa.out: \
  LINKER_SCRIPT  := nrf52_test_gcc_nrf52.ld
...
uf2: default
	./uf2conv.py -c -b 0x26000 -f 0xada52840 -o $(OUTPUT_DIRECTORY)/nrf52840_xxaa.uf2 $(OUTPUT_DIRECTORY)/nrf52840_xxaa.bin
